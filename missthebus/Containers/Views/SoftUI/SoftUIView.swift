...
open class SoftUIView: UIControl {
    ...
    public func setThemeColor(_ major: UIColor, _ dark: UIColor, _ light: UIColor){
        self.mainColor = major.cgColor
        self.darkShadowColor = dark.cgColor
        self.lightShadowColor = light.cgColor
    }
    ...
    open func setContentView(_ contentView: UIView?, ableTouch: Bool) {
        resetContentView(contentView, ableTouch: ableTouch)
    }
    ...
    open override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        case .normal, .toggleButton, .staticView:
            break
        }
...
private extension SoftUIView {
    ...
    func resetContentView(_ contentView: UIView?,
        ...
        contentView.map {
            $0.isUserInteractionEnabled = ableTouch
            addSubview($0)
        }
